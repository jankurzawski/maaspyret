...
This is a basic retinotopy script that:
 ...
 - Allows the user to select which they would like to use
 - Allows on the fly, non-slip based stimulus frequency and duration (i.e. TR).
 - Supports a fixation color change detection (recording button presses).
 - Is extensible - if new masks or carriers are provided, you can use them. 
 - Starts with either t or 5 from scanner trigger - records r/g/b/y/1/2/3/4
